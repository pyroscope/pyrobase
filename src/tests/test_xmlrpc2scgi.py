...
class HelperTest(unittest.TestCase):
    ...
    def test_encode_payload(self):
        ...
        for data, headers, expected in testcases:
            self.failUnlessEqual(xmlrpc2scgi._encode_payload(data, headers=headers), expected)
    ...
    def test_parse_headers(self):
        ...
        bad_headers = b"a: b\nc; d\n\n"
        self.failUnlessRaises(xmlrpc2scgi.SCGIException, xmlrpc2scgi._parse_headers, bad_headers)
    ...
    def test_parse_response(self):
        ...
        self.failUnlessRaises(xmlrpc2scgi.SCGIException, xmlrpc2scgi._parse_response, bad_data)
