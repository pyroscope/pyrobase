# -*- coding: utf-8 -*-
#
# pyrobase documentation build configuration file, created by
...
project = u'pyrobase'
copyright = u'2009 - 2020, PyroScope Project'
...
latex_documents = [
    ('index', 'pyrobase.tex', u'pyrobase Documentation', u'pyroscope', 'manual'),
]
...
man_pages = [
    ('index', 'pyrobase', u'pyrobase Documentation', [u'pyroscope'], 1)
]
...
texinfo_documents = [
    ('index', 'pyrobase', u'pyrobase Documentation',
     u'pyroscope', 'pyrobase', 'One line description of project.',
     'Miscellaneous'),
]
